package com.ytech.account.renewpassword
 ...
 */
@Route(path = ARouterConstant.ModuleAccount.FRAGMENT_RENEW_PASSWORD)
class RenewPasswordFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_renew_password, container, false)
    }
