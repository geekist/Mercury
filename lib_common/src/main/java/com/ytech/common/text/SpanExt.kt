...
fun TextView.colorSizeSpan(str: String, range: IntRange, color: Int = Color.RED, scale: Float = 1.5f) {
    text = str.toColorSpan(range, color).toSizeSpan(range, scale)
}
...
fun TextView.styleSpan(str: String,
                       range: IntRange,
